...
if(isset($_POST['submit'])){
   ...
   if($select_admin->rowCount() > 0){
      ...
      $message2[] = 'Hatalı kullanıcı adı veya parola!';
   }
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <br>
      <input type="text" name="name" required placeholder="Kullanıcı Adı" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
